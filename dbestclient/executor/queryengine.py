...
class QueryEngine:
    ...
    def approx_sum(self, x_min, x_max, runtime_config):
        ...
        result = integrate.quad(f_pRx, x_min, x_max, epsabs=runtime_config['epsabs'], epsrel=runtime_config['epsrel'])[0]
    ...
    def approx_count(self, x_min, x_max, runtime_config):
        ...
        result = integrate.quad(
            ...
            x_min,
            x_max,
            epsabs=runtime_config['epsabs'],
            epsrel=runtime_config['epsrel']
        )[0]
        result = result * float(self.n_total_point)
